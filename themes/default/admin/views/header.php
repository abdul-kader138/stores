                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php if (SHOP) {
                        ...
                        <li class="dropdown hidden-xs"><a class="btn tip" title="<?= lang('shop') ?>"
                                                          data-placement="bottom" href="<?= base_url() ?>"><i
                                    ...
                                    if ($Owner || $Admin) {
                                        ...
                                        <li class="mm_products">
                                            ...
                                            <ul>
                                                ...
                                                <li id="products_print_qr">
                                                    <a class="submenu" href="<?= admin_url('products/print_qr'); ?>">
                                                        <i class="fa fa-tags"></i>
                                                        <span class="text"> <?= lang('Print_QR'); ?></span>
                                                    </a>
                                                </li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li id="system_settings_allergy_facts">
                                                        <a href="<?= admin_url('system_settings/allergy_facts') ?>">
                                                            <i class="fa fa-th-list"></i><span
                                                                    class="text"> <?= lang('allergy_facts'); ?></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li id="site_logs_index">
                                                        <a href="<?= admin_url('site_logs') ?>">
                                                            <i class="fa fa-file-text"></i><span
                                                                    class="text"> <?= lang('site_logs'); ?></span>
                                                        </a>
                                                    </li>
                                            ...
                                            <li class="mm_products">
                                                ...
                                                <ul>
                                                    ...
                                                    <?php if ($GP['products-barcode']) {
                                                        ...
                                                        <li id="products_print_qr">
                                                            <a class="submenu"
                                                               href="<?= admin_url('products/print_qr'); ?>">
                                                                <i class="fa fa-tags"></i>
                                                                <span class="text"> <?= lang('Print_QR'); ?></span>
                                                            </a>
                                                        </li>
