...
<div class="box">
    <div class="box-header no-print">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Print_QR'); ?></h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well well-sm no-print">
                    ...
                    <?= admin_form_open('products/print_qr', 'id="barcode-print-form" data-toggle="validator"'); ?>
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            <?= lang('style', 'style'); ?>
                            <?php $opts = ['' => lang('select') . ' ' . lang('style'),  10 => lang('10_per_sheet')]; ?>
                            ...
                            if (!empty($barcodes)) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        echo '<span class="barcode_image">'.$this->sma->make_qr_code($item['barcode']).'<br><br></span>';
                                        if ($style == 50) {
                                            echo '</div>';
                                        }
                                        echo '</div>';
