                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-small">
                            ...
                            <p>
                                ...
                                class="text-info">(<?= lang('name') . ', ' . lang('code') . ', ' . lang('barcode_symbology') . ', ' . lang('brand') . ', ' . lang('category_code') . ', ' . lang('unit_code') . ', ' . lang('sale') . ' ' . lang('unit_code') . ', ' . lang('purchase') . ' ' . lang('unit_code') . ', ' . lang('cost') . ', ' . lang('margin') . ', ' . lang('alert_quantity') . ', ' . lang('tax') . ', ' . lang('tax_method') . ', ' . lang('image') . ', ' . lang('subcategory_code') . ', ' . lang('product_variants_sep_by') . ', ' . lang('recipe_one') . ', ' . lang('recipe_two') . ', ' . lang('origin') . ', ' . lang('food_allergy') . ', ' . lang('nutrition_facts') . ', ' . lang('pcf6') . ', ' . lang('hsn_code') . ', ' . lang('second_name') . ', ' . lang('supplier_name') . ', ' . lang('supplier_part_no') . ', ' . lang('supplier_price').', ' . lang('upc'); ?>
                                )</span> <?= lang('csv3'); ?>
                            </p>
