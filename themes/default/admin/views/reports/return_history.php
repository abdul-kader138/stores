...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getReturnHistoryReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, null,null, {"mRender": currencyFormat},null, {"mRender": sale_status}, {"mRender": row_status}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-random"></i><?= lang('Return_History_Report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('reports/return_history'); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getReturnHistoryReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getReturnHistoryReport/0/xls/?v=1' . $v)?>";
            return false;
        });
